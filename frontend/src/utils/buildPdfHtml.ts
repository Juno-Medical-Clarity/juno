...
<div class="header">
  <h1>Simplified Appointment Summary</h1>
  <p>Generated by Juno · Data processed securely</p>
</div>
${sections.join('')}
<div class="footer">Generated by Juno — Simplified for patient understanding</div>
</body></html>`;
}
