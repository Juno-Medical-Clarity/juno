...
# ---------------------------------------------------------------------------
# 5. test_juno_sink_success_emits_two_records
# ---------------------------------------------------------------------------
def test_juno_sink_success_emits_two_records():
    metric_logger = logging.getLogger("juno.metrics")
    event_logger = logging.getLogger("juno.markers")
...
# ---------------------------------------------------------------------------
# 6. test_juno_sink_failure_emits_error_level
# ---------------------------------------------------------------------------
def test_juno_sink_failure_emits_error_level():
    event_logger = logging.getLogger("juno.markers")
...
# ---------------------------------------------------------------------------
# 7. test_juno_context_outside_request
# ---------------------------------------------------------------------------
def test_juno_context_outside_request():
    ctx = JunoContext.from_g(function="x", foo="bar")
    scope = Scope("test.op")
    ctx.apply(scope)
