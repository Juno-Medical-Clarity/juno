  ...
  return (
    <div className="legal-page">
      ...
      <article>
        ...
        <h2>Analytics</h2>
        <p>
          We use <strong>Google Analytics 4</strong> to understand how people use this trial
        ...
        <h2>Contact</h2>
        <p>Questions about this trial can be directed to tejitpabari99@gmail.com.</p>
      </article>
    </div>
  );
}
